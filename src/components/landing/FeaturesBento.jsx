...
export default function FeaturesBento() {
  ...
  return (
    <section ref={containerRef} className="relative w-full py-32 bg-slate-50 dark:bg-[#020202] overflow-hidden transition-colors duration-500">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter mb-4 uppercase transition-colors">
            The Arsenal of <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#FF9900] dark:from-[#FFCC00] dark:to-primary">Debate</span>
          </h2>
          <p className="text-lg md:text-xl text-slate-600 dark:text-white/50 max-w-2xl mx-auto font-light tracking-wide transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 auto-rows-[250px]">
          ...
          <div ref={addToRefs} className="md:col-span-2 md:row-span-2 bg-white/70 dark:bg-gradient-to-br dark:from-white/[0.05] dark:to-transparent backdrop-blur-xl border border-slate-200/60 dark:border-white/[0.08] rounded-3xl p-8 flex flex-col justify-between group overflow-hidden relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] hover:border-slate-300 dark:hover:border-primary/30 transition-colors duration-500">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 rounded-full bg-white dark:bg-black border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6 shadow-sm dark:shadow-[inset_0_0_15px_rgba(251,121,11,0.2)] group-hover:shadow-[0_0_15px_rgba(251,121,11,0.2)] dark:group-hover:shadow-[inset_0_0_20px_rgba(251,121,11,0.5)] transition-shadow duration-500">
              ...
              <h3 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-3 transition-colors">2v2 & Free-For-All Arenas</h3>
              <p className="text-slate-600 dark:text-white/60 leading-relaxed text-lg font-light transition-colors">
            ...
            {/* Decorative Visual */}
            <div className="absolute -bottom-16 -right-16 w-80 h-80 bg-slate-100/50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-full flex items-center justify-center group-hover:border-primary/20 transition-colors duration-500">
              <div className="w-56 h-56 rounded-full border border-primary/20 flex items-center justify-center animate-[spin_15s_linear_infinite]">
                 ...
                 <div className="w-40 h-40 rounded-full border border-slate-300 dark:border-white/5 flex items-center justify-center animate-[spin_10s_linear_infinite_reverse]">
                   <div className="w-2 h-2 bg-slate-400 dark:bg-white/50 rounded-full absolute bottom-0 shadow-sm dark:shadow-[0_0_10px_rgba(255,255,255,0.5)]" />
                 </div>
              </div>
            </div>
          </div>
          ...
          <div ref={addToRefs} className="md:col-span-1 md:row-span-1 bg-white/70 dark:bg-gradient-to-br dark:from-white/[0.05] dark:to-transparent backdrop-blur-xl border border-slate-200/60 dark:border-white/[0.08] rounded-3xl p-6 flex flex-col justify-between group relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] hover:border-slate-300 dark:hover:border-white/20 transition-colors duration-500">
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight mb-2 transition-colors">Live Polling</h3>
              <p className="text-sm text-slate-600 dark:text-white/50 font-light leading-relaxed transition-colors">Capture audience sentiment instantly. Create multi-option polls and watch votes update in real-time.</p>
            </div>
          </div>

          {/* Feature 3: Real-Time Engine (Tall) */}
          <div ref={addToRefs} className="md:col-span-1 md:row-span-2 bg-gradient-to-b from-primary/5 dark:from-primary/10 to-transparent backdrop-blur-xl border border-primary/20 dark:border-primary/30 rounded-3xl p-6 flex flex-col justify-between group relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(251,121,11,0.4),0_0_30px_rgba(251,121,11,0.05)] hover:shadow-[0_15px_40px_rgb(0,0,0,0.08)] dark:hover:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(251,121,11,0.6),0_0_50px_rgba(251,121,11,0.15)] transition-all duration-500">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 rounded-full bg-white dark:bg-black border border-primary/30 dark:border-primary/40 flex items-center justify-center mb-6 shadow-sm dark:shadow-[0_0_15px_rgba(251,121,11,0.3)] group-hover:shadow-md dark:group-hover:shadow-[0_0_25px_rgba(251,121,11,0.6)] transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight mb-3 transition-colors">Socket.io Engine</h3>
              <p className="text-slate-600 dark:text-white/60 text-sm leading-relaxed mb-6 font-light transition-colors">
            ...
            <div className="relative h-40 w-full border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/50 rounded-xl overflow-hidden p-4 flex flex-col gap-3 group-hover:border-primary/30 transition-colors">
               <div className="flex items-center gap-2">
                 <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                 <span className="text-[10px] text-slate-500 dark:text-white/50">WSS:// Connected</span>
               </div>
               ...
               <div className="flex flex-col gap-2 mt-auto">
                 <div className="h-1.5 w-[80%] bg-slate-300 dark:bg-white/40 rounded-full" />
                 <div className="h-1.5 w-[50%] bg-slate-300 dark:bg-white/40 rounded-full" />
               </div>
            </div>
          </div>
          ...
          <div ref={addToRefs} className="md:col-span-1 md:row-span-1 bg-white/70 dark:bg-gradient-to-br dark:from-white/[0.05] dark:to-transparent backdrop-blur-xl border border-slate-200/60 dark:border-white/[0.08] rounded-3xl p-6 flex flex-col justify-between group relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] hover:border-slate-300 dark:hover:border-white/20 transition-colors duration-500">
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight mb-2 transition-colors">Role-Based Entry</h3>
              <p className="text-sm text-slate-600 dark:text-white/50 font-light leading-relaxed transition-colors">Enter rooms as an active debater or spectate and vote as an audience member.</p>
            </div>
          </div>
          ...
          <div ref={addToRefs} className="md:col-span-4 md:row-span-1 bg-white/70 dark:bg-gradient-to-br dark:from-white/[0.05] dark:to-transparent backdrop-blur-xl border border-slate-200/60 dark:border-white/[0.08] rounded-3xl p-8 md:px-16 flex items-center justify-between group relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] hover:border-primary/30 transition-colors duration-500">
            ...
            {/* Visual element */}
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-slate-200 dark:border-white/10 bg-white dark:bg-black/50 flex items-center justify-center relative group-hover:border-primary/30 transition-colors duration-500 shadow-sm dark:shadow-inner flex-shrink-0">
               ...
               <div className="absolute top-6 right-6 md:top-8 md:right-8 w-4 h-4 bg-red-500 rounded-full border-[3px] border-slate-50 dark:border-black" />
            </div>
          </div>
